...
{
  MainNode = engine::CGame::getSceneManager()->addAnimatedMeshSceneNode((scene::IAnimatedMesh*)MainMesh);
 ...
 */
f32 CAnimatedModel::getWallCollision(engine::ERayType type, CStaticModel* other, core::vector3df& normal)
{
