...
class AnimatedModel : public ModelEntity {
  public:
    ...
    f32 getWallCollisionP(StaticModel* other, core::vector3df& origin, core::vector3df& end, core::vector3df& normal);
    f32 getWallCollisionQ(StaticModel* other, core::vector3df& origin, core::vector3df& end, core::vector3df& normal);
};
